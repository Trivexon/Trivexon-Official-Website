...
const projects = [
  {
    ...
    description: "A sleek, high-performance website built for MNA Capital Advisors — a financial advisory firm. Designed for credibility and trust with a professional UI, SEO optimization, and smooth user experience to drive client inquiries.",
  ...
  },
  {
    ...
    description: "A premium facade glazing and cladding brand with a high-impact digital presence — modern design, performance optimization, and top-ranking SEO.",
