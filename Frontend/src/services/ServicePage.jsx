          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 xl:col-span-7 flex justify-end relative mt-10 lg:mt-0">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl w-full lg:w-[125%] lg:translate-x-16 xl:translate-x-24 2xl:translate-x-32 flex items-center justify-center">
                <img src={heroImage || "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80"} alt={`${badge} Services by Trivexon`} className={heroImageClassName} fetchpriority="high" decoding="async" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-[rgba(255,255,255,0.05)] group">
                <img src={overview.image || "/images/home-img-2.webp"} alt={`${badge} Overview and Process`} className="w-full h-auto max-h-[650px] object-cover opacity-90 transition-transform duration-700 " loading="lazy" decoding="async" />
